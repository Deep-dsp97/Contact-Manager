...
const ContactShow = ({contact, onDelete, onUpdate}) => {
  ...
  return (
    <Col sm={6} md={4} lg={3}>
      <div className="contact-show p-4 rounded">
        ...
        {
          isEditing ? <ContactEdit contact={contact} onUpdate={onUpdate} activeEdit={closeContactEditForm}/> : null
        }
      </div>
    </Col>
  )
